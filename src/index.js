        ...
        if(this.prev_slide != this.slide) {
            ...
            if(this.slide == 0) {
                this.main_text.setText('');
                                        ...
                                        this.scene.launch('Game', { phase_id: 2, num_egg_per_color: 5, rythm_list: {"blueEgg":[1,2,1], "redEgg":[2,2,1], "yellowEgg":[2,1,1], "cyanEgg":[1,1,2]}, distractor_list: []})
                                        this.scene.pause()
                                        ...
                                        this.scene.launch('Game', { phase_id: 1, num_egg_per_color: 5, rythm_list: {"blueEgg":[1,2,1], "redEgg":[1,999,1], "yellowEgg":[1,999,1], "cyanEgg":[1,999,1]}, distractor_list: ["redEgg","yellowEgg","cyanEgg"]})
                                        this.scene.pause()
